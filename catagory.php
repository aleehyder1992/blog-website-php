...
$sql="SELECT * FROM blog LEFT JOIN catagories ON blog.catagory=catagories.cat_id LEFT JOIN user ON blog.author_id=user.user_id WHERE cat_id='$id' ORDER BY blog.publish_date DESC";
                ...
                $img=$result['blog_image']
					...
					<div class="flex-grow-1 flex-part2">
						...
						<ul>
							...
							<li>
								<a class="fw-bold text-danger" href=""> <span><i class="fa fa-tag" aria-hidden="true"></i></span> 
								<?=  $result['cat_name']; ?>
							</a>
						    </li>
						</ul>
